...
CREATE UNIQUE INDEX "appointments_calendar_external_unique" ON "appointments" USING btree ("business_id","calendar_provider","external_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "provider_events_provider_external_unique" ON "provider_events" USING btree ("business_id","provider","external_event_id");--> statement-breakpoint
